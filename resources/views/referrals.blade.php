      ...
      <div class="w-full mt-3 text-xs">
        ...
        <div class="rounded-t-lg" style="box-shadow:0 0 3px 3px lightgray;">
          <div id="tb_header" class="bg-gray-900 rounded-t-lg text-white py-2 text-center tracking-tighter" style="font-size: 10px;">
            <div style="width: 32%; float:left; text-center">Influencers</div>
            <div style="width: 11%; float:left; text-center">Gifted</div>
            <div style="width: 11%; float:left; text-center">Paid</div>
            ...
            @foreach ($referrals as $referral)
                <div class="w-full bg-white py-3" style="border-bottom:1px solid #333;">
                  <div style="width: 32%; float:left; text-center" class="relative">
                    <img src="{{ asset('img/profile-image/' . $referral->influencerInfo->avatar . '.jpg') }}" alt="{{ $referral->influencerInfo->avatar  }}" class="absolute rounded-full w-10 left-2" style="top:50%; transform:translateY(-50%);">
                    <span class="ml-10">
