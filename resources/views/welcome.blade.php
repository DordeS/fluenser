...
<body class="antialiased">
    <div>
        <nav class="bg-white">
            <div class="max-w-7xl mx-auto" style="border-bottom: 1px solid gray;">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="md:block">
                        <div class="ml-4 flex items-center md:ml-6" id="main_btn">
                            ...
                            @else
                            <a href="{{ route('login') }}"
                                class="text-gray-500 rounded-md text-xs md:text-sm font-medium tracking-wide hover:text-indigo-700 mr-2">{{__('Log In')}}</a>

                            @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="text-gray-500 rounded-md text-xs md:text-sm font-medium hover:text-indigo-700 tracking-wide">{{__('Sign Up')}}</a>
                            @endif
                            @endauth
                        </div>
                        @endif
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <p class="text-3xl font-bold text-center mt-8" style="font-family: 'Poppins', sans-serif; font-weight:600;">The home of influencers</p>
                ...
                <div class="full grid grid-cols-2 gap-x-3 mt-6" style="font-family: 'Poppins', sans-serif; font-weight:500;">
                    <div class="px-1 py-1">
                        <a class="block text-center py-2 w-full rounded-md text-sm md:text-md text-white" style="background: #0ac2c8">Hire an Influencer</a>
                    </div>
                    <div class="px-1 py-1">
                        <a class="block text-center py-2 w-full rounded-md text-sm md:text-md" style="border: 1px solid gray; color:#0ac2c8">Join as Influencer</a>
                    </div>
                </div>
            </div>
            <div class="max-w-7xl mx-auto mt-5 relative" style="margin-bottom: 13vw;">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-5">
                ...
                <div id="featured_slide" class="w-full relative overflow-hidden">
                    <div style="width: 50%; visibility: hidden; padding:10px;">
                        <div class="card">
                            <img src="{{asset('img/profile-image/'.$featuredInfluencers[0]->top_img.'.jpg')}}" alt="hidden image" style="width: 100%;">
