              ...
              <div class="flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Inbox</a>
          ...
          @else
            <div class="md:hidden fixed bottom-0 bg-black w-full" id="mobile-menu">
                ...
                <div class="col-span-1">
                    <a href="#" class="text-white block px-3 py-2 rounded-md text-center text-base font-medium">
